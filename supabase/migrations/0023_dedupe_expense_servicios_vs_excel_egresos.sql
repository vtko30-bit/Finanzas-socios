-- Evita doble conteo: el mismo pago puede venir en `excel_egresos` (categorizado) y en
-- `excel_egresos_banco_estado_servicios` (desagregado). El resumen pivot debe contar solo uno.
